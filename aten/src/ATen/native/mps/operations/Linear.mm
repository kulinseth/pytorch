...
Tensor _mps_linear(
  ...
  Tensor output = at::detail::empty_mps(output_size,
                                        input.scalar_type(),
                                        c10::nullopt,
                                        kMPS,
                                        c10::nullopt,
    ...
    const Tensor & weight)
{
  ...
  Tensor output = at::detail::empty_mps(input_size,
    ...
    const Tensor& grad_output, const Tensor& input, const Tensor& weight, bool bias_defined)
{
  ...
  Tensor output = at::detail::empty_mps({grad_output_reshaped.size(1), input_reshaped.size(1)},
                                        grad_output.scalar_type(),
                                        c10::nullopt,
                                        kMPS,
                                        c10::nullopt,
                                        grad_output.suggest_memory_format());
  Tensor bias = at::detail::empty_mps({grad_output_reshaped.size(1)},
                                        grad_output.scalar_type(),
                                        c10::nullopt,
                                        kMPS,
                                        c10::nullopt,
