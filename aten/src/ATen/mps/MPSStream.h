...
struct TORCH_API MPSEvent
{
  ...
  int notifyEvent(bool needsLock, bool syncEvent, MTLSharedEventNotificationBlock block);
...
private:
  ...
  int notifyEventLocked(bool syncEvent, MTLSharedEventNotificationBlock block);
};
